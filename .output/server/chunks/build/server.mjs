...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Cz3RlRnB.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-YYBjTA-b.mjs')
  },
  {
    name: "equipe",
    path: "/equipe",
    component: () => import('./equipe-BIJJqcQq.mjs')
  },
  {
    name: "medias",
    path: "/medias",
    component: () => import('./medias-D6616YJS.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-C4j4ojIH.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-HB1x-PPi.mjs')
  },
  {
    name: "admin",
    path: "/admin",
  ...
  },
  {
    ...
    component: () => import('./login-3VrYBQRs.mjs')
  },
  {
    name: "organisation",
    path: "/organisation",
    component: () => import('./organisation-CpPsq1ui.mjs')
  },
  {
    name: "admin-messages",
    path: "/admin/messages",
...
const namedMiddleware = {
  admin: () => import('./admin-BX2i5NES.mjs')
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(visible)) {
          _push2(`<div class="site-loader" aria-live="polite" aria-busy="true" role="status" aria-label="Chargement du site" data-v-a711501b><div class="site-loader__inner" data-v-a711501b><div class="site-spinner" aria-hidden="true" data-v-a711501b><span class="site-spinner__ring" data-v-a711501b></span></div><img${ssrRenderAttr("src", _imports_0)} alt="OXYNOVA RDC SARL" class="site-loader__logo" width="120" height="64" data-v-a711501b></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SiteLoader.vue");
...
const oxynovaContent = {
  ...
  description: "OXYNOVA RDC est une entreprise spécialisée dans les solutions complètes en ingénierie biomédicale en RDC. Elle se positionne comme un acteur clé pour améliorer l'accès à l'oxygène médical, fournir les équipements biomédicaux, sécuriser les installations hospitalières, assurer l'assainissement des structures sanitaires et professionnaliser la maintenance biomédicale.",
  objective: "Entreprise technique haut de gamme, accessible aux projets publics, au service de la performance et de la sécurité des structures de santé en RDC.",
  vision: "Être le partenaire de référence dans les domaines de l'ingénierie médicale et des solutions technologiques intégrées en Afrique centrale.",
  mission: "Garantir un accompagnement fiable, sécurisé et durable à nos partenaires dans toutes les phases de leurs projets, depuis les études de faisabilité jusqu'à la livraison et la maintenance.",
  ...
  positioning: "Entreprise technique haut de gamme mais accessible aux projets publics.",
  legal: {
...
const siteSeo = {
  ...
  defaultDescription: "OXYNOVA RDC SARL : ingénierie biomédicale, oxygène médical PSA, équipements hospitaliers, infrastructures techniques, maintenance et formation pour les structures de santé en République Démocratique du Congo.",
  keywords: [
    "OXYNOVA RDC",
...
const pageSeo = {
  home: {
    ...
    description: "Partenaire technique des hôpitaux et centres de santé en RDC. OXYNOVA RDC SARL conçoit, installe et maintient vos solutions d’oxygène médical, équipements biomédicaux et infrastructures hospitalières.",
    path: "/"
  },
  about: {
    title: "À propos — Expertise biomédicale locale",
    description: "Découvrez OXYNOVA RDC SARL : vision, mission, engagements et expertise en ingénierie biomédicale au service des structures de santé congolaises.",
    path: "/about"
  },
  services: {
    title: "Services — Ingénierie, oxygène & maintenance",
    description: "Gestion de projets santé, ingénierie biomédicale, infrastructures d’oxygène médical, digitalisation hospitalière et formation des équipes techniques.",
    path: "/services"
  },
  organisation: {
    title: "Organisation — Structure & directions",
    description: "Organigramme OXYNOVA RDC SARL : assemblée des associés, direction générale et directions technique, commerciale, digitale, logistique et formation.",
    path: "/organisation"
  },
  equipe: {
    title: "Équipe — Direction & collaborateurs",
    description: "Rencontrez l’équipe OXYNOVA RDC SARL, dirigée par NTUMBA MUKUNA Joelle, Directrice générale, au service de la performance biomédicale en RDC.",
    path: "/equipe"
  },
  medias: {
    title: "Médias — Galerie & actualités",
    description: "Photos et médias OXYNOVA RDC : interventions techniques, centrales d’oxygène médical et projets hospitaliers en République Démocratique du Congo.",
    path: "/medias"
  },
  contact: {
    title: "Contact — Devis & accompagnement",
    description: "Contactez OXYNOVA RDC SARL à Kinshasa pour un devis, un audit biomédical ou un projet d’oxygène médical. Email, téléphone et WhatsApp disponibles.",
    path: "/contact"
  }
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SiteLoader = __nuxt_component_0;
      const _component_NuxtLayout = __nuxt_component_1;
      const _component_NuxtPage = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_SiteLoader, null, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CpjNinEt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-hzdEMoos.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, defaultSiteUrl as e, useSeoMeta as f, asyncDataDefaults as g, createError as h, fetchDefaults as i, useState as j, _imports_0 as k, useRoute as l, defineNuxtRouteMiddleware as m, navigateTo as n, oxynovaContent as o, pageSeo as p, resolveRouteObject as r, siteSeo as s, useHead as u };
