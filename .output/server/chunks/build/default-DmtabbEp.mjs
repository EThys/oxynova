import { useSSRContext, defineComponent, mergeProps, unref, ref, watch, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, computed } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderTeleport, ssrRenderStyle, ssrRenderSlot } from 'vue/server-renderer';
import { o as oxynovaContent, j as useRoute, _ as __nuxt_component_0$2 } from './server.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "w-full font-sans" }, _attrs))} data-v-9f8225ea><div class="container mx-auto px-4" data-v-9f8225ea><div class="${ssrRenderClass([__props.compact ? "nav-row--compact" : "nav-row--full", "nav-row flex justify-between items-center"])}" data-v-9f8225ea>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(oxynovaContent).images.logo)} alt="OXYNOVA RDC SARL" class="${ssrRenderClass([__props.compact ? "nav-logo--compact" : "nav-logo--full", "nav-logo object-contain object-left transition-all duration-300"])}" data-v-9f8225ea${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`<div class="hidden lg:flex items-center gap-1" data-v-9f8225ea><!--[-->`);
      ssrRenderList(links, (item) => {
        _push(`<!--[-->`);
        if (item.children) {
          _push(`<div class="relative" data-v-9f8225ea><button type="button" class="${ssrRenderClass([{ "nav-link--active": isGroupActive(item) }, "nav-link inline-flex items-center gap-1.5"])}" data-v-9f8225ea>${ssrInterpolate(item.label)} <svg class="${ssrRenderClass([{ "rotate-180": unref(openDropdown) === item.label }, "w-3.5 h-3.5 transition-transform duration-200"])}" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-9f8225ea><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" data-v-9f8225ea></path></svg></button>`);
          if (unref(openDropdown) === item.label) {
            _push(`<div class="absolute left-0 top-full pt-2 min-w-[200px]" data-v-9f8225ea><div class="bg-white border border-gray-100 rounded-[4px] shadow-xl shadow-brand-900/10 py-2 overflow-hidden" data-v-9f8225ea><!--[-->`);
      ...
      _push(`<!--]--></div><div class="hidden lg:flex items-center gap-3" data-v-9f8225ea>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/contact",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-9f8225ea${_scopeId}>Parler à un expert</span><svg class="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-9f8225ea${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" data-v-9f8225ea${_scopeId}></path></svg>`);
          } else {
            return [
      ...
      _push(`</div><button type="button" class="${ssrRenderClass([__props.compact ? "w-10 h-10" : "w-11 h-11", "lg:hidden relative z-[70] flex flex-col items-center justify-center gap-1.5 rounded-[3px] border border-gray-200 hover:border-brand-600 hover:bg-brand-50 transition-all duration-300"])}"${ssrRenderAttr("aria-expanded", unref(isOpen))} aria-label="Menu" data-v-9f8225ea><span class="${ssrRenderClass([{ "burger-line--top": unref(isOpen) }, "burger-line"])}" data-v-9f8225ea></span><span class="${ssrRenderClass([{ "burger-line--mid": unref(isOpen) }, "burger-line"])}" data-v-9f8225ea></span><span class="${ssrRenderClass([{ "burger-line--bot": unref(isOpen) }, "burger-line"])}" data-v-9f8225ea></span></button></div></div>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isOpen)) {
          _push2(`<div class="fixed inset-0 z-[60] lg:hidden" data-v-9f8225ea><div class="absolute inset-0 bg-brand-900/50 backdrop-blur-sm" data-v-9f8225ea></div><aside class="menu-panel absolute top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col" data-v-9f8225ea><div class="px-6 pt-6 pb-4 border-b border-gray-100 flex items-center justify-between" data-v-9f8225ea><div class="flex items-center gap-3 min-w-0" data-v-9f8225ea><img${ssrRenderAttr("src", unref(oxynovaContent).images.logo)} alt="OXYNOVA RDC SARL" class="h-10 w-auto max-w-[9rem] object-contain" data-v-9f8225ea></div><button type="button" class="w-10 h-10 rounded-[3px] bg-gray-50 text-brand-900 font-[900] hover:bg-brand-700 hover:text-white transition-colors" aria-label="Fermer" data-v-9f8225ea> ✕ </button></div><nav class="flex-1 overflow-y-auto px-4 py-6" data-v-9f8225ea><ul class="space-y-1" data-v-9f8225ea><!--[-->`);
          ssrRenderList(links, (item, i) => {
            _push2(`<!--[-->`);
            if (item.children) {
              _push2(`<li class="menu-item" style="${ssrRenderStyle({ animationDelay: `${80 + i * 50}ms` })}" data-v-9f8225ea><button type="button" class="flex items-center gap-4 px-4 py-4 rounded-[4px] w-full text-left hover:bg-brand-50 text-[#1a1a1b] transition-all" data-v-9f8225ea><span class="text-[12px] font-[900] tracking-widest w-7 text-brand-600/50" data-v-9f8225ea>${ssrInterpolate(String(i + 1).padStart(2, "0"))}</span><span class="text-[17px] font-[900] uppercase tracking-wider flex-1" data-v-9f8225ea>${ssrInterpolate(item.label)}</span><svg class="${ssrRenderClass([{ "rotate-90": unref(mobileGroupOpen) === item.label }, "w-4 h-4 transition-transform"])}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-9f8225ea><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-9f8225ea></path></svg></button>`);
              if (unref(mobileGroupOpen) === item.label) {
                _push2(`<ul class="ml-11 mb-2 space-y-1" data-v-9f8225ea><!--[-->`);
                ssrRenderList(item.children, (child) => {
                  _push2(`<li data-v-9f8225ea>`);
              ...
              _push2(`<li class="menu-item" style="${ssrRenderStyle({ animationDelay: `${80 + i * 50}ms` })}" data-v-9f8225ea>`);
              _push2(ssrRenderComponent(_component_nuxt_link, {
                to: item.to,
                ...
                default: withCtx((_, _push3, _parent2, _scopeId) => {
                  if (_push3) {
                    _push3(`<span class="${ssrRenderClass([isActive(item.to) ? "text-brand-200" : "text-brand-600/50 group-hover:text-brand-600", "text-[12px] font-[900] tracking-widest w-7"])}" data-v-9f8225ea${_scopeId}>${ssrInterpolate(String(i + 1).padStart(2, "0"))}</span><span class="text-[17px] font-[900] uppercase tracking-wider flex-1" data-v-9f8225ea${_scopeId}>${ssrInterpolate(item.label)}</span><svg class="${ssrRenderClass([isActive(item.to) ? "opacity-100" : "", "w-4 h-4 opacity-40 group-hover:opacity-100 group-hover:translate-x-1 transition-all"])}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-9f8225ea${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-9f8225ea${_scopeId}></path></svg>`);
                  } else {
                    return [
                      createVNode("span", {
          ...
          _push2(`<!--]--></ul></nav><div class="p-6 border-t border-gray-100 bg-brand-50/60 space-y-4" data-v-9f8225ea><a${ssrRenderAttr("href", `tel:${unref(oxynovaContent).contact.phone.replace(/\s/g, "")}`)} class="block text-brand-700 font-bold text-sm" data-v-9f8225ea>${ssrInterpolate(unref(oxynovaContent).contact.phone)}</a>`);
          _push2(ssrRenderComponent(_component_nuxt_link, {
            to: "/contact",
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                _push3(` Parler à un expert <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-9f8225ea${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" data-v-9f8225ea${_scopeId}></path></svg>`);
              } else {
                return [
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-9f8225ea"]]), { __name: "Navbar" });
...
//# sourceMappingURL=default-DmtabbEp.mjs.map
